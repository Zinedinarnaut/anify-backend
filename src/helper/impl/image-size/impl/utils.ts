...
export const readUInt64 = (input: Uint8Array, offset: number, isBigEndian: boolean): bigint => getView(input, offset).getBigUint64(0, !isBigEndian);
...
export function readUInt(input: Uint8Array, bits: 16 | 32, offset = 0, isBigEndian = false): number {
